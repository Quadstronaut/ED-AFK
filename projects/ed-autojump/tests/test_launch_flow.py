...
def _loadgame(group="CmdrFour", commander="CmdrOne"):
...
def _spec(commander="CmdrOne", profile_slug="account1"):
    return LaunchSpec(
...
def test_full_flow_succeeds_when_nav_enabled():
    ...
    r = launch_and_enter_game(
        ...
        expected_group="CmdrFour", expected_commander="CmdrOne",
    ...
    assert nav.calls == ["CmdrOne"]
    assert r.load_game_event.commander == "CmdrOne"
